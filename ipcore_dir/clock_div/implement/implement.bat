...
xst -ifn xst.scr
move clock_div_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clock_div_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clock_div_exdes.ucf clock_div_exdes

echo 'Running map'
map -timing -pr b clock_div_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clock_div_exdes -w routed.ncd routed.v
cd ..
